...
Clone the project.
To launch the game initially open a terminal and run the command "npm i". Then run the commande "npm run dev". Open your browser and go to "localhost:8080". To move the character use the arrow keys.
